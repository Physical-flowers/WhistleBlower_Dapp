...
import { mintTokens } from "./contract/actions/USDK";
...
async function testUsdkContract() {
  ...
  // Setup the account
  let privateKey = new Ed25519PrivateKey(
    "0xa6bc454dac2b7177c2f3fd119964a051d68e49aad04e216176932f4dc1d1b47f"
  );
  const pin = Account.fromPrivateKey({ privateKey });

  privateKey = new Ed25519PrivateKey(
    "0xc7f3556f097199143b5bf1170030a4e36bbf8f6a8c0b800b250db21337d1f860"
  );
  ...
  try {
    let result = await mintTokens(
      pin,
      ili.accountAddress.toStringWithoutPrefix(),
      1000000000000
    );
