...
async function example() {
  ...
  console.log("Alice's private key is: ", alice.privateKey.bcsToBytes());
  console.log("Bob's private key is: ", bob.privateKey.bcsToHex());
...
const bobPrivateKeyArray = Uint8Array.from([
    145, 155, 154, 127, 120, 175, 134, 254,
    244, 202, 201,  65,  71, 239, 203,  83,
    115, 187, 119,  98, 168, 126, 129, 151,
     68, 152,  60,  46,  41, 170, 166,  20
  ]);
  ...
  const bobPrivateKeyBase64 = uint8ArrayToBase64(bobPrivateKeyArray);
  console.log(`Bob's private key in Base64: ${bobPrivateKeyBase64}`);
